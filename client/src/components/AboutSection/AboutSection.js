  ...
  return (
    <StyledAboutSection>
      ...
      <p>
        ...
        cosmetics are crafted from the finest organic ingredients, ensuring that
        what you put on your skin is not only effective but also safe and
        nourishing.
      </p>
      ...
      <ul>
        <li>
          ...
          <p>
            100% Organic Ingredients: We source our ingredients from sustainable
            farms, ensuring purity and potency.
          </p>
        </li>
        ...
        <li>
          <p>
            {' '}
            We are proudly cruelty-free, never testing on animals and committed
            to ethical beauty practices.
          </p>
          <div>
            {' '}
      ...
      <p>
        ...
        designed to cater to all your beauty needs. Each product is meticulously
        formulated to bring out your natural glow, making you feel beautiful
        inside and out
      </p>
    </StyledAboutSection>
  );
